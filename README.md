...
```bash
git clone https://github.com/kajalshar098ma-collab/saarthi-app.git
cd saarthi-app
...
Usage
Launch the app.
Set up your timetable by adding subjects and time slots.
Start a study session using the timer.
Receive reminders and track your progress.
Technologies
